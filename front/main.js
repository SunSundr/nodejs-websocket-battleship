        ...
        (t.AsyncMode = c),
          ...
          (t.isValidElementType = function (e) {
            return (
              ...
              e === p ||
              e === h ||
              ("object" == typeof e && null !== e && (e.$$typeof === g || e.$$typeof === m || e.$$typeof === u || e.$$typeof === s || e.$$typeof === d || e.$$typeof === v || e.$$typeof === b || e.$$typeof === w || e.$$typeof === y))
            );
          }),
          (t.typeOf = S);
      },
      ...
      448: (e, t, n) => {
        ...
        function Cl(e, t, n) {
          ...
          if ("hidden" === r.mode)
            if (0 == (1 & t.mode)) (t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), Oo(Au, ju), (ju |= n);
              ...
              if (0 == (1073741824 & n))
                return (e = null !== a ? a.baseLanes | n : n), (t.lanes = t.childLanes = 1073741824), (t.memoizedState = { baseLanes: e, cachePool: null, transitions: null }), (t.updateQueue = null), Oo(Au, ju), (ju |= e), null;
        ...
        function Yl(e, t, n) {
          ...
          switch ((na(t), t.tag)) {
                    ...
                    for (i in (ve(n, o), (s = o)))
                      if (s.hasOwnProperty(i)) {
                        ...
                        "style" === i
                          ...
                          : "suppressContentEditableWarning" !== i && "suppressHydrationWarning" !== i && "autoFocus" !== i && (l.hasOwnProperty(i) ? null != c && "onScroll" === i && Fr("scroll", e) : null != c && b(e, i, c, u));
                      }
                    switch (n) {
                      case "input":
                        if (e.type === "password") {
            ...
            case 23:
              return (
                fs(), (r = null !== t.memoizedState), null !== e && (null !== e.memoizedState) !== r && (t.flags |= 8192), r && 0 != (1 & t.mode) ? 0 != (1073741824 & ju) && ($l(t), 6 & t.subtreeFlags && (t.flags |= 8192)) : $l(t), null
              );
            case 24:
            case 25:
              return null;
                    ...
                    switch (t.tag) {
                      ...
                      case 13:
                        if (null !== (r = t.memoizedState))
                          return null !== r.dehydrated ? (Oo(ui, 1 & ui.current), (t.flags |= 128), null) : 0 != (n & t.child.childLanes) ? _l(e, t, n) : (Oo(ui, 1 & ui.current), null !== (e = Hl(e, t, n)) ? e.sibling : null);
                        Oo(ui, 1 & ui.current);
                        break;
                      case 19:
    ...
    (() => {
                ...
                switch (h) {
                  case 123:
                    ...
                    if (((m = u.substring(F, L)), 0 === p && (p = (B = B.replace(c, "").trim()).charCodeAt(0)), 64 === p)) {
                      ...
                      if (((F = (m = t(r, _, m, h, d + 1)).length), 0 < A && ((w = l(3, m, (_ = n(z, B, R)), r, N, O, F, h, d, s)), (B = _.join("")), void 0 !== w && 0 === (F = (m = w.trim()).length) && ((h = 0), (m = ""))), 0 < F))
                        switch (h) {
                          case 115:
                            B = B.replace(S, i);
                          case 100:
      ...
      function on(e, t) {
        ...
        var n = t.p[0],
          r = void 0 !== e && e !== n;
        return (
          t.h.g || Kt("ES5").S(t, e, r), r ? (n[En].P && (en(t), Lt(4)), Rt(e) && ((e = an(t, e)), t.l || un(t, e)), t.u && Kt("Patches").M(n[En].t, e, t.u, t.s)) : (e = an(t, n, [])), en(t), t.u && t.v(t.u, t.s), e !== xn ? e : void 0
        );
      }
      function an(e, t, n) {
        if (Jt(t)) return t;
          ...
          var r = cr(e + "/fulfilled", function (e, t, n, r) {
            ...
            a = cr(e + "/rejected", function (e, t, r, o, a) {
              return {
                ...
                meta: ir(ar({}, a || {}), { arg: r, requestId: t, rejectedWithValue: !!o, requestStatus: "rejected", aborted: "AbortError" === (null == e ? void 0 : e.name), condition: "ConditionError" === (null == e ? void 0 : e.name) }),
              };
            }),
            i =
                      ...
                      return (function (e, t) {
                        ...
                        switch (b.label) {
                          case 0:
                            return (
                              b.trys.push([0, 4, , 5]),
                              null === (w = g = null == (i = null == n ? void 0 : n.condition) ? void 0 : i.call(n, e, { getState: u, extra: s })) || "object" != typeof w || "function" != typeof w.then ? [3, 2] : [4, g]
                            );
                          case 1:
                            (g = b.sent()), (b.label = 2);
                          case 2:
        ...
        Pr = (function () {
          ...
          return (
            (e.prototype.startTimer = function () {
              ...
              (this.count = this.size === 15 && window.RepeatTurn && window.StartTimerTime ? Math.max(15 - ((Date.now() - window.StartTimerTime) / 1000 | 0), 0) : this.size),
      ...
      function $r(t) {
        ...
        return e.createElement(
          ...
          e.createElement(
            ...
            e.createElement(jr, {
              count: window.RepeatTurn && window.StartTimerTime ? Math.max(15 - ((Date.now() - window.StartTimerTime) / 1000 | 0), 0) : 15,
              endTimer: function () {
          ...
          function e(e) {
            ...
            (this.webSocket = r),
              (r.onmessage = function (e) {
                const changeClassMyCanvas = function(status) {
                  if (window.myCanvas) {
                    if (status) {
                      window.myCanvas.classList.remove("canvas-cursor-wait");
                      window.myCanvas.classList.add("canvas-cursor-crosshair");
                    } else {
                      window.myCanvas.classList.remove("canvas-cursor-crosshair");
                      window.myCanvas.classList.add("canvas-cursor-wait");
                    }
                  }
                };
                ...
                switch ((console.log(r.type), r.type)) {
                  case "turn":
                    ...
                    window.StartTimerTime = a ? Date.now() : undefined;
                    changeClassMyCanvas(a);
                    t(Co({ isCurrentPlayer: a })), t(_r({ timer: a }));
                    break;
                  case "attack":
                    window.RepeatTurn = undefined;
                  ...
                  case "repeat":
                    ...
                    t(Yo({ position: l, status: s, player: c })), qo.playAudio(s);
                    setTimeout(() => {
                      t(Yo({ position: l, status: i.repeatStatus, player: c }));
                    }, 400);
                    break;
                  case "start_game":
                    window.RepeatTurn = undefined;
                    window.myCanvas = undefined;
                    ...
                    setTimeout(() => {
                      ...
                      if (canvases.length === 4) {
                        canvases[1].classList.add("no-pointer-events");
                        canvases[3].classList.add("canvas-cursor-crosshair");
                        window.myCanvas = canvases[3];
                      }
                    }, 600);
                    break;
                  case "reg":
              ...
              (r.onopen = function () {
                console.log("\uD83D\uDEA2 A modified version of the Battleship client application has been launched \uD83D\uDE01 Enjoy!");
                console.log("connected");
              });
              (r.onerror = function () {
                console.log("\u26D4 Modified Battleship client launched, but WebSocket connection error");
                console.log("error");
              });
              (r.onclose = function () {
                ...
                const reConnect = setInterval(() => {
                  if (!isConnecting) {
                    isConnecting = true;
                    var newConnect = new WebSocket("ws://localhost:3000/reconnect");
                    newConnect.onopen = () => {
                ...
                setTimeout(() => {
                  ...
                  overlayDiv.className = 'overlay-connection-lost';
                  const messageDiv = document.createElement('div');
                  messageDiv.className = 'message-connection-lost';
                  messageDiv.textContent = 'WebSocket connection lost';
